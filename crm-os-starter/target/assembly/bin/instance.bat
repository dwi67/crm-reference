...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\instance\org.apache.karaf.instance.core\4.2.0.fuse-000191-redhat-1\org.apache.karaf.instance.core-4.2.0.fuse-000191-redhat-1.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.core\4.2.0.fuse-000191-redhat-1\org.apache.karaf.shell.core-4.2.0.fuse-000191-redhat-1.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\ops4j\pax\logging\pax-logging-api\1.10.1\pax-logging-api-1.10.1.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\jline\jline\3.6.1\jline-3.6.1.jar
