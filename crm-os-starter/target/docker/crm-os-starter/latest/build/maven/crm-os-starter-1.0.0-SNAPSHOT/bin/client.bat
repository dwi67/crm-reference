...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\org.apache.karaf.client\4.2.0.fuse-000191-redhat-1\org.apache.karaf.client-4.2.0.fuse-000191-redhat-1.jar
...
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\slf4j\slf4j-api\1.7.25\slf4j-api-1.7.25.jar
