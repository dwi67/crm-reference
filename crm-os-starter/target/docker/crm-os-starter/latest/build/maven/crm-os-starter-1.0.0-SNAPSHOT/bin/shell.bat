...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.core\4.2.0.fuse-000191-redhat-1\org.apache.karaf.shell.core-4.2.0.fuse-000191-redhat-1.jar
